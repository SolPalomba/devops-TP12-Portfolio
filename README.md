...
Aprendí DevOps desde cero en Operaciones1 utilizando herramientas gratuitas.

Cada TP representa una implementación práctica real, evidenciada mediante repositorios en GitHub.
